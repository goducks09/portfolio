...
const ConnectH2Wrap = styled(H2Wrap)`
  margin-bottom: 3rem;
`;

const ConnectBody = styled.p`
  max-width: 520px;
  margin: 0 auto 3rem;
  color: var(--muted);
  line-height: 1.8;
  ...
  return (
    <Connect id="connect">
      ...
      <RevealWrapper>
        ...
        <ConnectLinks>
          <ConnectBtn href="https://github.com/goducks09" target="_blank" rel="noopener noreferrer">
          ...
          <ConnectBtn href="https://www.linkedin.com/in/chris-pulver/" target="_blank" rel="noopener noreferrer">
